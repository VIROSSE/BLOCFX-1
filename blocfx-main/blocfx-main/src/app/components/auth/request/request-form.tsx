...
export default function RequestForm() {
    ...
    return (
        <div className=' bg-white  items-center justify-center flex flex-col gap-10'>
            <div className='flex'>
                <h1 className='text-2xl md:text-3xl font-cenios leading-8 text-center'>Waiting List Registration</h1>
            </div>
            <div className='flex w-full   flex-col items-center gap-6 md:px-12'>
                <form onSubmit={handleSubmit(onSubmit)} className='grid space-y-4'>
                    ...
                    <div className='grid'>
                        ...
                        />
                        {!passwordMatch && <p className='text-red-400 text-xs text-left p-1 px-2 -mb-2'>Retype password is not matched!</p>}
                    </div>
                    ...
                    <div className='text-xs flex justify-end px-5 -pt-3 '>
                        <div>
                            <span>Fields marked</span> <span className='text-red-500'>*</span> <span>are required</span>
                        </div>
                    </div>
                    ...
                    <div className="pt-5 md:pt-10  flex flex-col justify-center items-center gap-5">
                        <SubmitButtonWithIcon title='Sign up' disabled={onSubmitLoading || !passwordMatch} />
